...
| 4. RESEARCH | **Evidence User:** Critically appraises evidence to ensure own specific practice is up to date. Participates in audits relevant to own role. | **Evidence Appraiser:** Learns to translate research into practice. Conducts service audits to benchmark current performance against standards. | **Evidence Translator:** Identifies gaps in evidence, leads audit / evaluation, and implements research findings to change clinical guidelines / protocols. | **Evidence Generator:** Leads formal research, drives impact case studies, and publishes / disseminates findings to influence national / regional policy. |
...
| **2** | **Direct Supervision** | Can act, but supervisor must be physically present in the room/space. |
...
*   **Mappings:** `[EP 1.7]`, `[RPS 4.1-4.11]`, `[AP-G 1.7]`, `[AP-MH E1 5.2]`
*   **[EPA RATING 1-5]**
...
*   **Mappings:** `[RPS 6.1-6.2]`, `[AP-G 1.8]`, `[AP-MH D2 4.4]`, `[CLP 2.3]`
*   **[EPA RATING 1-5]**
...
*   **Mappings:** `[EP 1.5]`, `[RPS 3.1]`, `[RPS 2.3]`, `[AP-G 1.5]`, `[AP-MH A1 1.2]`
*   **[EPA RATING 1-5]**
...
| **2** | **Direct Supervision** | **Assisted Lead:** Led specific workstreams but required significant direction on methodology, strategy, or stakeholder management. |
...
*   **Mappings:** `[EP 3.3]`, `[AP-G 3.4]`, `[AP-MH A1 1.4]`
*   **[EPA RATING 1-5]**
